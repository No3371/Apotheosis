...
public class DeadlyConfig {
	...
	public static boolean merchantsSellRandomAffixedLoot = true;
	...
	public static void loadConfigs() {
		...
		merchantsSellRandomAffixedLoot = c.getBoolean("Merchants Sell Random Affixed Loots", DeadlyConstants.AFFIXES, true, "Will merchants come with random affixed loot trades?");
